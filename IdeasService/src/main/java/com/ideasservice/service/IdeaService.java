...
public class IdeaService {
	...
	public IdeasDto updateIdeaForUser(Long ideaId, UserDto userDto, IdeasDto updatedDto)
		...
		if (existingIdea == null) {
			...
			if (!updatedDto.getIdeaTitle().equals("") && updatedDto.getIdeaTitle() != null
					&& !updatedDto.getIdeaTitle().equals(existingIdea.getIdeaTitle())) {
				existingIdea.setIdeaTitle(updatedDto.getIdeaTitle());
			}
			if (!updatedDto.getDecription().equals("") && updatedDto.getDecription() != null
					&& !updatedDto.getDecription().equals(existingIdea.getDecription())) {
				existingIdea.setDecription(updatedDto.getDecription());
			}
			if (!updatedDto.getStatus().equals("") && updatedDto.getStatus() != null
					&& !updatedDto.getStatus().equals(existingIdea.getStatus())) {
				existingIdea.setStatus(updatedDto.getStatus());
			}
			if (!updatedDto.getSources().equals("") && updatedDto.getSources() != null
					&& !updatedDto.getSources().equals(existingIdea.getSources())) {
				existingIdea.setSources(updatedDto.getSources());
			}
			if (!updatedDto.getTopicsIcluded().equals("") && updatedDto.getTopicsIcluded() != null
					&& !updatedDto.getTopicsIcluded().equals(existingIdea.getTopicsIcluded())) {
	...
	public String deleteIdea(Long ideaId, UserDto userDto) throws NoIdeasFound, NoUserFoundException {
		UserDto user = checkIfUserExistsOrNot(userDto.getEmail());
		Idea existingIdea = ideaRepo.findByUserIdAndId(user.getUserId(), ideaId);
		if (existingIdea == null) {
			throw new NoIdeasFound("No Idea Found");
